...
- Ensure [Python 3](https://www.python.org/downloads/) is installed (preferably a version 3.10, but older ones should work by lowering some dependency versions in the requirements file).
